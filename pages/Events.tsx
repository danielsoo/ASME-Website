                ...
                <>
                    ...
                    <div className="md:hidden space-y-6">
                        {pastEvents.map(event => {
                            ...
                            return (
                                <div key={event.id} className={`bg-white border border-slate-200 rounded-xl p-5 flex flex-row gap-4 shadow-sm hover:shadow-md transition-shadow min-w-0 overflow-hidden ${isExpanded ? 'min-h-[255px]' : 'h-[255px]'}`}>
